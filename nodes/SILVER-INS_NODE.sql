@id("914b54fa-5e2d-48ab-9423-c69fcf428b5f")
@nodeType("456")
WITH base_vendor AS (
...
vendor_activity_7 as (
    SELECT  VENDOR_ID, 
            ...
            SUM(YELLOW_CAB_TRIPS.TRIP_DISTANCE)::NUMBER TRIP_DISTANCE_7,
            SUM(YELLOW_CAB_TRIPS.FARE_AMOUNT)::NUMBER FARE_AMOUNT_7,
...
vendor_location_activity_7 as (
    SELECT 
        ...
        LOCATION.ZONE, 
        SUM(YELLOW_CAB_TRIPS.FARE_AMOUNT) LOC_FARE_AMOUNT_7, 
